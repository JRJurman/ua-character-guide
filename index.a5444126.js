const e=()=>{if(!window["tram-space"])throw new Error("\n\t\t\tTram-One: app has not started yet, but hook was called. Is it being invoked outside a component function?\n\t\t\thttps://github.com/Tram-One/tram-one/issues/178\n\t\t");return window},t=t=>({setup:i=>{const a=e();return a["tram-space"][i]=t(),a["tram-space"][i]},get:t=>e()["tram-space"][t],set:(t,i)=>{e()["tram-space"][t]=i}}),{setup:i,get:a}=t((()=>({branch:[],branchIndices:{"":0}}))),n=e=>a(e).branch.join("/"),o=e=>{a(e).branchIndices[n(e)]+=1},r=e=>{const t=a(e).branchIndices[n(e)];return`${n(e)}[${t}]`};var l=new WeakMap,s=Symbol("iteration key");function c(e,t,i){var a=t.get(i);a&&a.forEach(e.add,e)}function h(e){e.cleaners&&e.cleaners.forEach(b,e),e.cleaners=[]}function b(e){e.delete(this)}var d=[],u=!1;function g(e,t,i,a){if(e.unobserved)return Reflect.apply(t,i,a);if(-1===d.indexOf(e)){h(e);try{return d.push(e),Reflect.apply(t,i,a)}finally{d.pop()}}}function f(e){var t=d[d.length-1];t&&(m(t,e),function(e,t){var i=t.target,a=t.key;"iterate"===t.type&&(a=s);var n=l.get(i),o=n.get(a);o||(o=new Set,n.set(a,o)),o.has(e)||(o.add(e),e.cleaners.push(o))}(t,e))}function p(e){(function(e){var t=e.target,i=e.key,a=e.type,n=l.get(t),o=new Set;if("clear"===a?n.forEach((function(e,t){c(o,n,t)})):c(o,n,i),"add"===a||"delete"===a||"clear"===a){var r=Array.isArray(t)?"length":s;c(o,n,r)}return o})(e).forEach(y,e)}function y(e){m(e,this),"function"==typeof e.scheduler?e.scheduler(e):"object"==typeof e.scheduler?e.scheduler.add(e):e()}function m(e,t){if(e.debugger&&!u)try{u=!0,e.debugger(t)}finally{u=!1}}function A(){return d.length>0}var S=Symbol("is reaction");function E(e,t){void 0===t&&(t={});var i=e[S]?e:function t(){return g(t,e,this,arguments)};return i.scheduler=t.scheduler,i.debugger=t.debugger,i[S]=!0,t.lazy||i(),i}var w=new WeakMap,v=new WeakMap,k=Object.prototype.hasOwnProperty;function T(e){var t=v.get(e);return A()&&"object"==typeof e&&null!==e?t||G(e):t||e}function I(e,t){var i=e.next;return e.next=function(){var a=i.call(e),n=a.done,o=a.value;return n||(t?o[1]=T(o[1]):o=T(o)),{done:n,value:o}},e}var P={has:function(e){var t=w.get(this),i=Reflect.getPrototypeOf(this);return f({target:t,key:e,type:"has"}),i.has.apply(t,arguments)},get:function(e){var t=w.get(this),i=Reflect.getPrototypeOf(this);return f({target:t,key:e,type:"get"}),T(i.get.apply(t,arguments))},add:function(e){var t=w.get(this),i=Reflect.getPrototypeOf(this),a=i.has.call(t,e),n=i.add.apply(t,arguments);return a||p({target:t,key:e,value:e,type:"add"}),n},set:function(e,t){var i=w.get(this),a=Reflect.getPrototypeOf(this),n=a.has.call(i,e),o=a.get.call(i,e),r=a.set.apply(i,arguments);return n?t!==o&&p({target:i,key:e,value:t,oldValue:o,type:"set"}):p({target:i,key:e,value:t,type:"add"}),r},delete:function(e){var t=w.get(this),i=Reflect.getPrototypeOf(this),a=i.has.call(t,e),n=i.get?i.get.call(t,e):void 0,o=i.delete.apply(t,arguments);return a&&p({target:t,key:e,oldValue:n,type:"delete"}),o},clear:function(){var e=w.get(this),t=Reflect.getPrototypeOf(this),i=0!==e.size,a=e instanceof Map?new Map(e):new Set(e),n=t.clear.apply(e,arguments);return i&&p({target:e,oldTarget:a,type:"clear"}),n},forEach:function(e){for(var t=[],i=arguments.length-1;i-- >0;)t[i]=arguments[i+1];var a=w.get(this),n=Reflect.getPrototypeOf(this);f({target:a,type:"iterate"});var o,r=function(t){for(var i=[],a=arguments.length-1;a-- >0;)i[a]=arguments[a+1];return e.apply(void 0,[T(t)].concat(i))};return(o=n.forEach).call.apply(o,[a,r].concat(t))},keys:function(){var e=w.get(this),t=Reflect.getPrototypeOf(this);return f({target:e,type:"iterate"}),t.keys.apply(e,arguments)},values:function(){var e=w.get(this),t=Reflect.getPrototypeOf(this);f({target:e,type:"iterate"});var i=t.values.apply(e,arguments);return I(i,!1)},entries:function(){var e=w.get(this),t=Reflect.getPrototypeOf(this);f({target:e,type:"iterate"});var i=t.entries.apply(e,arguments);return I(i,!0)},get size(){var e=w.get(this),t=Reflect.getPrototypeOf(this);return f({target:e,type:"iterate"}),Reflect.get(t,"size",e)}};P[Symbol.iterator]=function(){var e=w.get(this),t=Reflect.getPrototypeOf(this);f({target:e,type:"iterate"});var i=t[Symbol.iterator].apply(e,arguments);return I(i,e instanceof Map)};var R={get:function(e,t,i){return e=k.call(P,t)?P:e,Reflect.get(e,t,i)}},C="object"==typeof window?window:Function("return this")(),L=new Map([[Map,R],[Set,R],[WeakMap,R],[WeakSet,R],[Object,!1],[Array,!1],[Int8Array,!1],[Uint8Array,!1],[Uint8ClampedArray,!1],[Int16Array,!1],[Uint16Array,!1],[Int32Array,!1],[Uint32Array,!1],[Float32Array,!1],[Float64Array,!1]]);var U=Object.prototype.hasOwnProperty,N=new Set(Object.getOwnPropertyNames(Symbol).map((function(e){return Symbol[e]})).filter((function(e){return"symbol"==typeof e})));var O={get:function(e,t,i){var a=Reflect.get(e,t,i);if("symbol"==typeof t&&N.has(t))return a;f({target:e,key:t,receiver:i,type:"get"});var n=v.get(a);if(A()&&"object"==typeof a&&null!==a){if(n)return n;var o=Reflect.getOwnPropertyDescriptor(e,t);if(!o||!1!==o.writable||!1!==o.configurable)return G(a)}return n||a},has:function(e,t){var i=Reflect.has(e,t);return f({target:e,key:t,type:"has"}),i},ownKeys:function(e){return f({target:e,type:"iterate"}),Reflect.ownKeys(e)},set:function(e,t,i,a){"object"==typeof i&&null!==i&&(i=w.get(i)||i);var n=U.call(e,t),o=e[t],r=Reflect.set(e,t,i,a);return e!==w.get(a)||(n?i!==o&&p({target:e,key:t,value:i,oldValue:o,receiver:a,type:"set"}):p({target:e,key:t,value:i,receiver:a,type:"add"})),r},deleteProperty:function(e,t){var i=U.call(e,t),a=e[t],n=Reflect.deleteProperty(e,t);return i&&p({target:e,key:t,oldValue:a,type:"delete"}),n}};function G(e){return void 0===e&&(e={}),w.has(e)||"function"==typeof(t=e.constructor)&&t.name in C&&C[t.name]===t&&!L.has(t)?e:v.get(e)||function(e){var t=function(e){return L.get(e.constructor)}(e)||O,i=new Proxy(e,t);return v.set(e,i),w.set(i,e),function(e){l.set(e,new Map)}(e),i}(e);var t}var F=E;const D=(e,t)=>t,M=(e,t)=>{const i=(e=>t=>"tagName"in t&&t.tagName===e?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP)(t),a=document.createTreeWalker(e,NodeFilter.SHOW_ELEMENT,i),n=[a.currentNode];for(;a.nextNode();)n.push(a.currentNode);return n},W={index:-1,tagName:"",scrollLeft:0,scrollTop:0,selectionStart:null,selectionEnd:null,selectionDirection:void 0};var Y=e=>{let t;const i=F((()=>{let i=t,a=W;if(i){a=W;if(i.contains(document.activeElement)){const e=document.activeElement,t=M(i,e.tagName);a.index=t.findIndex((t=>t===e)),a.tagName=e.tagName,a.scrollLeft=e.scrollLeft,a.scrollTop=e.scrollTop,a.selectionStart=e.selectionStart,a.selectionEnd=e.selectionEnd,a.selectionDirection=e.selectionDirection||void 0}const e=document.createElement("div");i.replaceWith(e),e["tram-tag-reaction"]=i["tram-tag-reaction"],e["tram-tag-new-effects"]=i["tram-tag-new-effects"],e["tram-tag-cleanup-effects"]=i["tram-tag-cleanup-effects"],i=e}if(t=e(),i){let e;if(a.index>=0){const i=M(t,a.tagName),o=i.map(D).sort((n=a.index,(e,t)=>Math.abs(e-n)-Math.abs(t-n)))[0];e=i[o];try{void 0!==e.setSelectionRange&&e.setSelectionRange(a.selectionStart,a.selectionEnd,a.selectionDirection)}catch(e){}e.scrollLeft=a.scrollLeft,e.scrollTop=a.scrollTop}t["tram-tag"]=!0,t["tram-tag-reaction"]=i["tram-tag-reaction"],t["tram-tag-new-effects"]=i["tram-tag-new-effects"],t["tram-tag-cleanup-effects"]=i["tram-tag-cleanup-effects"],i.replaceWith(t),e&&e.focus&&e.focus()}var n}));if(void 0===t)throw new Error("\n\t\t\tTram-One: tagResult was not defined after building the tag.\n\t\t\thttps://github.com/Tram-One/tram-one/issues/177\n\t\t");return t["tram-tag-reaction"]=i,t};const{setup:x,get:B,set:$}=t((()=>({}))),_=$,{setup:K,get:H,set:q}=t((()=>[])),Q=e=>{const t=H(e);t.splice(0,t.length)},j=q;var V=e=>{const t={...B("tram-effect-queue")},i=[...H("tram-key-queue")];(e=>{const t=B(e);Object.keys(t).forEach((e=>delete t[e]))})("tram-effect-queue"),Q("tram-key-queue"),Q("tram-global-key-queue");const a=e(),n=B("tram-effect-store"),o=B("tram-effect-queue"),r=a["tram-tag-new-effects"]||[],l=Object.keys(o).filter((e=>!(e in n))).map((e=>o[e])),s=r.concat(l);a["tram-tag-new-effects"]=s;const c=a["tram-tag-store-keys"]||[],h=H("tram-key-queue"),b=c.concat(h);return a["tram-tag-store-keys"]=b,_("tram-effect-queue",t),j("tram-key-queue",i),a},X={},z={};const J=e=>"number"==typeof e||"boolean"==typeof e||"function"==typeof e||e instanceof Date||e instanceof RegExp?e.toString():e,Z=e=>!("string"==typeof e&&/^[\n\r\s]+$/.test(e)),ee=(e,t)=>{Array.isArray(t)&&t.map(J).filter(Z).forEach((t=>{if(Array.isArray(t))ee(e,t);else{if("string"==typeof t){if(e.lastChild&&"#text"===e.lastChild.nodeName)return void(e.lastChild.nodeValue+=t);t=document.createTextNode(t)}t&&t.nodeType&&e.appendChild(t)}}))};z=ee;const te=e=>!/^xmlns($|:)/i.test(e),ie=e=>"classname"===e.key.toLowerCase()?{key:"class",value:e.value}:e,ae=e=>"htmlFor"===e.key?{key:"for",value:e.value}:e,ne=e=>(t,i,a)=>{if("!--"===t)return document.createComment(i.comment);const n=e?document.createElementNS(e,t):document.createElement(t);return Object.keys(i).filter(te).filter((e=>t=>Object.prototype.hasOwnProperty.call(e,t))(i)).map((e=>t=>({key:t,value:e[t]}))(i)).map(ie).map(ae).filter((e=>t=>"on"!==t.key.slice(0,2)||((e,t,i)=>{e[t]=i,e.events=e.events?e.events.concat(t):[t]})(e,t.key,t.value))(n)).filter((e=>t=>e.setAttributeNS(null,t.key,t.value))(n)),z(n,a),n};(X=ne).html=ne(),X.svg=ne("http://www.w3.org/2000/svg");var oe;oe=function(e,t,i){const a=function(e,a,n){const o=i[e];return o?o(a,n):t(e,a,n)},n=e(a);return n.h=a,n};var re,le={};le=function(e){return function(t,i,a){for(var n in i)n in se&&(i[se[n]]=i[n],delete i[n]);return e(t,i,a)}};var se={class:"className",for:"htmlFor","http-equiv":"httpEquiv"};re=function(e,t){t||(t={comments:!0});const i=t.concat||function(e,t){return String(e)+String(t)},a=e=>{switch(typeof e){case"function":case"string":case"object":case"undefined":return e;default:return i("",e)}};return!1!==t.attrToProp&&(e=le(e)),function(n){for(var o=1,r="",l=arguments.length,s=[],c=0;c<n.length;c++)if(c<l-1){var h=arguments[c+1],b=w(n[c]),d=o;switch(d){case 13:r+=h,h="";case 10:case 9:case 7:d=8;break;case 4:d=5}b.push([0,d,h]),s.push.apply(s,b)}else s.push.apply(s,w(n[c]));var u=[null,{},[]],g=[[u,-1]];for(c=0;c<s.length;c++){var f=g[g.length-1][0],p=(b=s[c])[0];if(2===p&&/^\//.test(b[1])){var y=g[g.length-1][1];g.length>1&&(g.pop(),g[g.length-1][0][2][y]=e(f[0],f[1],f[2].length?f[2]:void 0))}else if(2===p){var m=[b[1],{},[]];f[2].push(m),g.push([m,f[2].length-1])}else if(5===p||0===p&&5===b[1]){for(var A,S="";c<s.length;c++)if(5===s[c][0])S=i(S,s[c][1]);else{if(0!==s[c][0]||5!==s[c][1])break;if("object"!=typeof s[c][2]||S)S=i(S,s[c][2]);else for(A in s[c][2])s[c][2].hasOwnProperty(A)&&!f[1][A]&&(f[1][A]=s[c][2][A])}11===s[c][0]&&c++;for(var E=c;c<s.length;c++)if(8===s[c][0]||5===s[c][0])f[1][S]?""===s[c][1]||(f[1][S]=i(f[1][S],s[c][1])):f[1][S]=a(s[c][1]);else{if(0!==s[c][0]||8!==s[c][1]&&5!==s[c][1]){!S.length||f[1][S]||c!==E||3!==s[c][0]&&12!==s[c][0]||(f[1][S]=S.toLowerCase()),3===s[c][0]&&c--;break}f[1][S]?""===s[c][2]||(f[1][S]=i(f[1][S],s[c][2])):f[1][S]=a(s[c][2])}}else if(14===p){y=g[g.length-1][1];g.pop(),g[g.length-1][0][2][y]=e(f[0],f[1],f[2].length?f[2]:void 0)}else if(0===p&&1===b[1])void 0===b[2]||null===b[2]?b[2]="":b[2]||(b[2]=i("",b[2])),Array.isArray(b[2][0])?f[2].push.apply(f[2],b[2]):f[2].push(b[2]);else if(1===p)f[2].push(b[1]);else if(11!==p&&12!==p&&3!==p)throw new Error("unhandled: "+p)}if(u[2].length>1&&/^\s*$/.test(u[2][0])&&u[2].shift(),u[2].length>2||2===u[2].length&&/\S/.test(u[2][1]))throw new Error("multiple root elements must be wrapped in an enclosing tag");return Array.isArray(u[2][0])&&"string"==typeof u[2][0][0]&&Array.isArray(u[2][0][2])&&(u[2][0]=e(u[2][0][0],u[2][0][1],u[2][0][2])),u[2][0];function w(e){var i=[];7===o&&(o=4);for(var a=0;a<e.length;a++){var n=e.charAt(a);if(13===o){if(!/-$/.test(r)||"-"!==n){r+=n;continue}t.comments&&i.push([8,r.substr(0,r.length-1)],[3]),r="",o=1}1===o&&"<"===n?(r.length&&i.push([1,r]),r="",o=2):">"===n&&"/"===e.charAt(a-1)||">"===n&&"-"===e.charAt(a-1)&&"-"===e.charAt(a-2)?(i.push([14]),r="",o=1):">"!==n||ce(o)||13===o?2===o&&/^!--$/.test(r)?(t.comments&&i.push([2,r],[5,"comment"],[11]),r=n,o=13):1===o?r+=n:2===o&&"/"===n&&r.length?(i.push([2,r]),r="",o=1):2===o&&/\s/.test(n)?(i.push([2,r]),r="",o=4):2===o?r+=n:4===o&&/[^\s"'=/]/.test(n)?(o=5,r=n):4===o&&/\s/.test(n)?(r.length&&i.push([5,r]),i.push([12])):5===o&&/\s/.test(n)?(i.push([5,r]),r="",o=6):5===o&&"="===n?(i.push([5,r],[11]),r="",o=7):5===o?r+=n:6!==o&&4!==o||"="!==n?6!==o&&4!==o||/\s/.test(n)?7===o&&'"'===n?o=10:7===o&&"'"===n?o=9:10===o&&'"'===n||9===o&&"'"===n?(i.push([8,r],[12]),r="",o=4):7!==o||/\s/.test(n)?8===o&&/\s/.test(n)?(i.push([8,r],[12]),r="",o=4):8!==o&&9!==o&&10!==o||(r+=n):(o=8,a--):(i.push([12]),/[\w-]/.test(n)?(r+=n,o=5):o=4):(i.push([11]),o=7):(2===o?i.push([2,r]):5===o?i.push([5,r]):8===o&&r.length&&i.push([8,r]),i.push([3]),r="",o=1)}if(r.length)switch(o){case 1:i.push([1,r]),r="";break;case 8:case 10:case 9:i.push([8,r]),r=""}return 5===o&&(i.push([5,r]),r=""),i}}};const ce=e=>9===e||10===e,he=(e,t={})=>{const i=Object.keys(t).reduce(((e,i)=>{const r=t[i];return{...e,[i]:(e,t)=>{const l=JSON.stringify(e);((e,t)=>{const i=a(e);i.branch.push(t),i.branchIndices[n(e)]||(i.branchIndices[n(e)]=0)})("tram-hook-key",`${i}[${l}]`),o("tram-hook-key");const s=(e=>{const t=a(e);return{branch:[...t.branch],branchIndices:{...t.branchIndices}}})("tram-hook-key"),c=()=>{((e,t)=>{const i=a(e),n=i.branchIndices;i.branch=[...t.branch],Object.keys(i.branchIndices).forEach((e=>{n[e]=t.branchIndices[e]||0}))})("tram-hook-key",s);const i=t?.map((e=>e instanceof Element?e:`${e}`));return r(e,i)},h=Y((()=>V(c)));return a("tram-hook-key").branch.pop(),h["tram-tag"]=!0,h["tram-tag-new-effects"]=h["tram-tag-new-effects"]||[],h["tram-tag-cleanup-effects"]=[],h}}}),{});return oe(re,X(e),i)};var be=e=>{const t=B("tram-effect-queue"),i=r("tram-hook-key");o("tram-hook-key");t[`${i}()`]=e};const de=he(null),ue=(e,t)=>(be((e=>{(t||[]).forEach((t=>{"string"==typeof t?e.insertAdjacentText("beforebegin",t):e.insertAdjacentElement("beforebegin",t)})),e.remove()})),de`<tram-fragment>${t}</tram-fragment>`),ge=e=>he(null,{"":ue,...e});var fe=G;const{setup:pe,get:ye}=t((()=>fe({})));var me=(e,t)=>{const i=ye("tram-observable-store");o("tram-hook-key");const a=e||r("tram-hook-key");Object.prototype.hasOwnProperty.call(i,a)||void 0===t||(i[a]=Array.isArray(t)?[...t]:{...t});const n=i[a];return!e&&H("tram-key-queue").push(a),n},Ae=e=>me(void 0,e);var Se,Ee,we,ve,ke,Te={};ve=function(){return function(e,t){var i={},a=decodeURIComponent;return function(){for(var e in t)l(e,t[e])}(),function(t,r){var l=function(e){var t=function(e){return~e.indexOf("/?")&&(e=e.replace("/?","?")),"/"==e[0]&&(e=e.slice(1)),"/"==e[e.length-1]&&(e=e.slice(0,-1)),e}(e).split("?"),r=~e.indexOf("%")?a:n;return function(e,t,i){if(e&&t.cb)for(var a=e.indexOf("#"),n=(a<0?e:e.slice(0,a)).split("&"),o=0;o<n.length;++o){var r=n[o].split("=");t.params[r[0]]=i(r[1])}return t}(t[1],o(t[0].split("/"),r,0,i,[])||{},r)}(t);return(l.cb||e)(l.params,r,t)};function n(e){return e}function o(e,t,i,a,n){if(a){if(i>=e.length){var l=a["@"];return l&&{cb:l,params:n.reduce((function(e,t){return e[t[0]]=t[1],e}),{})}}var s=t(e[i]),c=n.length;return o(e,t,i+1,a[s.toLowerCase()],n)||r(e,t,i+1,a,":",s,n,c)||r(e,t,e.length,a,"*",e.slice(i).join("/"),n,c)}}function r(e,t,i,a,n,r,l,s){l.length=s;var c=a[n];return c&&l.push([c["~"],r]),o(e,t,i,c,l)}function l(e,t){for(var a=e.split("/"),n=i,o=+("/"===e[0]);o<a.length;++o){var r=a[o],l=":"==r[0]?":":"*"==r[0]?"*":r.toLowerCase();n=n[l]||(n[l]={}),(":"==l||"*"==l)&&(n["~"]=r.slice(1))}n["@"]=t}}},(ke=(we=Te)&&we.define)&&ke.amd?ke("rlite",[],ve):Te?Te=ve():we.Rlite=ve();const Ie=()=>({matches:!1}),Pe=e=>({matches:!0,...e});Se=Ee=e=>(t="*")=>Te(Ie,{[t]:Pe})(e());var Re={};Re=Ee((()=>{const e=window.location.href.replace(window.location.origin,""),[t,i]=e.split("#"),a=t.includes("?");return`${t}${void 0!==i?a?`&hash=${i}`:`?hash=${i}`:""}`})),Re.setupUrlParams=Se,Re.useUrlParams=Re;function Ce(e,t){return me(e,t)}var Le=e=>{const t=(e=>{if("string"==typeof e){const t=document.querySelector(e);if(null===t)throw new Error("\n\t\t\t\tTram-One: could not find target, is the element on the page yet?\n\t\t\t\thttps://github.com/Tram-One/tram-one/issues/179\n\t\t\t");return t}return e})(e);if(!t.firstElementChild){const e=document.createElement("div");t.appendChild(e)}return t};const{setup:Ue,get:Ne,set:Oe}=t((()=>({})));var Ge=E,Fe=function(e){e.unobserved||(e.unobserved=!0,h(e)),"object"==typeof e.scheduler&&e.scheduler.delete(e)};const De=e=>{if(!("tram-tag"in e))return;e["tram-tag-store-keys"]&&e["tram-tag-store-keys"].forEach((e=>{((e,t)=>{const i=Ne(e);i[t]=i[t]+1||1})("tram-key-store",e)}));e["tram-tag-new-effects"]&&(e["tram-tag-cleanup-effects"]=[],e["tram-tag-new-effects"].forEach((t=>{let i;const a=Ge((()=>{"function"==typeof i&&i(),i=t(e)}));e["tram-tag-cleanup-effects"].push((()=>{"function"==typeof i&&i(),Fe(a)}))})),e["tram-tag-new-effects"]=[])},Me=e=>{e.forEach((e=>{var t;t=e,Ne("tram-key-store")[t]--}))},We=e=>{"tram-tag"in e&&(Fe(e["tram-tag-reaction"]),e["tram-tag-cleanup-effects"].forEach((e=>e())),Me(e["tram-tag-store-keys"]))},Ye=e=>"tram-tag"in e?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP,xe=e=>{const t=document.createTreeWalker(e,NodeFilter.SHOW_ELEMENT,Ye),i=[];for(;t.nextNode();)i.push(t.currentNode);return i},{setup:Be,get:$e}=t((()=>new MutationObserver((e=>{e.flatMap((e=>[...e.removedNodes])).flatMap(xe).forEach(We);e.flatMap((e=>[...e.addedNodes])).flatMap(xe).forEach(De),(()=>{const e=ye("tram-observable-store"),t=Ne("tram-key-store");Object.entries(t).forEach((([i,a])=>{0===a&&(delete e[i],delete t[i])}))})()}))));const _e=ge();var Ke=()=>_e` <section class="blank-page" /> `;const He=ge();var qe=({title:e,group:t,selection:i,source:a},n)=>He`
    <section
      class="page"
      page-color="grey"
      page-group=${t}
  ...
  `;const Qe=ge({page:qe,"blank-page":Ke});var je=(e,t)=>(be((e=>{const t=e.querySelector(".page-scroller-flex");t.addEventListener("focusin",(()=>(e=>{const t=e.scrollLeft,i=document.querySelector(".page:focus-within");e.scrollLeft=0;const a=i.offsetLeft-window.innerWidth/4,n=window.matchMedia("(prefers-reduced-motion: reduce)").matches;e.scrollTo({left:t}),e.scrollTo({left:a,behavior:n?"auto":"smooth"})})(t)))})),Qe` <section class="page-scroller">
  ...
  `}});var nt=()=>{Ce("PAGE_FILTERS",{selectedClass:"bard"});return at`
    <>
      <classes-selector />
      <page
        title="Bard"
  ...
  `};const ot=ge({annotation:Xe,page:qe});const rt=ge({annotation:Xe,page:qe,"backgrounds-selector":()=>{const e=Ce("PAGE_FILTERS",{background:"acolyte"}),t=t=>e.background=t;return ot`
  ...
  `}});const lt=ge({"page-scroller":je,"races-content":Ze,"page-filters":tt,"classes-content":nt,"backgrounds-content":()=>rt`
    <>
  ...
  `,annotation:Xe,page:qe});((e,t)=>{const a=Le(t);var n;window["tram-space"]={},x("tram-effect-store"),x("tram-effect-queue"),i("tram-hook-key"),pe("tram-observable-store"),Ue("tram-key-store"),K("tram-key-queue"),K("tram-global-key-queue"),Be("tram-mutation-observer"),n=a,$e("tram-mutation-observer").observe(n,{childList:!0,subtree:!0}),((e,t)=>{const i=ge({app:e})`<tram-one><app /></tram-one>`;t.replaceChild(i,t.firstElementChild)})(e,a)})((()=>{Ae({race:"",class:""});return lt`
    <main class="app">
      <page-scroller>
  ...
  `}),"#root");
//# sourceMappingURL=index.a5444126.js.map
